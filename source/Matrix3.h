...
class Matrix3 {
 ...
 public:
  ...
  REAL r1c1, r1c2, r1c3, r2c1, r2c2, r2c3, r3c1, r3c2, r3c3;

  // constructors
  Matrix3();
  Matrix3(REAL r1c1, REAL r1c2, REAL r1c3, REAL r2c1, REAL r2c2, REAL r2c3,
  ...
  inline Matrix3 operator+(const Matrix3 &M) const {
    return Matrix3(r1c1 + M.r1c1, r1c2 + M.r1c2, r1c3 + M.r1c3, r2c1 + M.r2c1,
                   r2c2 + M.r2c2, r2c3 + M.r2c3, r3c1 + M.r3c1, r3c2 + M.r3c2,
                   r3c3 + M.r3c3);
  }
  ...
  inline Matrix3 operator*(const REAL a) const {
    return Matrix3(a * r1c1, a * r1c2, a * r1c3, a * r2c1, a * r2c2, a * r2c3,
                   a * r3c1, a * r3c2, a * r3c3);
  }

  inline Matrix3 operator/(const REAL a) const {
    return Matrix3(r1c1 / a, r1c2 / a, r1c3 / a, r2c1 / a, r2c2 / a, r2c3 / a,
                   r3c1 / a, r3c2 / a, r3c3 / a);
  }

  inline Matrix3 operator-() const {
    return Matrix3(-r1c1, -r1c2, -r1c3, -r2c1, -r2c2, -r2c3, -r3c1, -r3c2,
                   -r3c3);
  }
  ...
  {
    return Matrix3(r1c1, r2c1, r3c1, r1c2, r2c2, r3c2, r1c3, r2c3, r3c3);
  }
  ...
  inline Matrix3 I() const  // inverse
  {
    ...
    return Matrix3(_r1c1, _r1c2, _r1c3, _r2c1, _r2c2, _r2c3, _r3c1, _r3c2,
                   _r3c3);
  }
  ...
  inline Vector3 log(const REAL tol = Tolerance::tol())
      const  // matrix logarithm (\in so(3)) represented as vector
  {
    const REAL theta = arcCos((tr() - 1.0) / 2.0);
    return (theta < tol)
               ? Vector3()
               : (theta / (2.0 * sin(theta)) *
                  Vector3(r2c3 - r3c2, r3c1 - r1c3,
                          r1c2 - r2c1));  // if theta ~= 0 return zero vector
  }

  inline void log(Vector3 &A, const REAL tol = Tolerance::tol())
      const  // matrix logarithm (\in so(3)) represented as vector
  {
    // Clean vector
    A.x = 0.0;
  ...
  {
    return sqrt(r1c1 * r1c1 + r1c2 * r1c2 + r1c3 * r1c3 + r2c1 * r2c1 +
                r2c2 * r2c2 + r2c3 * r2c3 + r3c1 * r3c1 + r3c2 * r3c2 +
                r3c3 * r3c3);
  }
  ...
  inline Vector3 operator[](int rowNum) const  // returns the ith row
  {
    switch (rowNum) {
      case 0:
        return Vector3(r1c1, r1c2, r1c3);
      case 1:
        return Vector3(r2c1, r2c2, r2c3);
      case 2:
        return Vector3(r3c1, r3c2, r3c3);
      default:
        throw "Bad [] access attemped on Matrix3.\n";
    }
  }

  inline bool isOrthogonal(const REAL tol = Tolerance::tol())
      const  // returns true if orthogonal within tol
  {
  ...
  inline bool goodNumerics() const {
    if ((r1c1 != r1c1) || (r1c2 != r1c2) || (r1c3 != r1c3) || (r2c1 != r2c1) ||
        (r2c2 != r2c2) || (r2c3 != r2c3) || (r3c1 != r3c1) || (r3c2 != r3c2) ||
        (r3c3 != r3c3))
      return false;
    else
  ...
  // speed functions
  static inline void matrix_times_vector(const Matrix3 &a, const Vector3 &b,
                                         Vector3 &c) {
  ...
  static inline void matrix_times_transposed(const Matrix3 &a, const Matrix3 &b,
                                             Matrix3 &c) {
