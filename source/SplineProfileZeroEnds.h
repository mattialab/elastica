...
public:
	...
	// Total number of control points, two of which are anchored to zero at the extrema
	// therefore the number of actual control parameters is Nw=ctrlPoints.size()+2
