...
// constructors
Matrix3::Matrix3() :
	r1c1(1.), r1c2(0.), r1c3(0.),
	r2c1(0.), r2c2(1.), r2c3(0.),
	r3c1(0.), r3c2(0.), r3c3(1.){}

Matrix3::Matrix3(	REAL r1c1, REAL r1c2, REAL r1c3,
...
Matrix3::Matrix3(const Vector3& S) : // skew matrix <-> vector mapping
	r1c1(0.),   r1c2(S.z),  r1c3(-S.y),
	r2c1(-S.z), r2c2(0.),   r2c3(S.x),
	r3c1(S.y),  r3c2(-S.x), r3c3(0.) {}

Matrix3::Matrix3(const Vector3& r1, const Vector3& r2, const Vector3& r3) :
	r1c1(r1.x), r1c2(r1.y), r1c3(r1.z),
	r2c1(r2.x), r2c2(r2.y), r2c3(r2.z),
	r3c1(r3.x), r3c2(r3.y), r3c3(r3.z) {}
...
{
	out.setf(std::ios::fixed | std::ios::right); out.width(A.PRINTPRECISION+3); out.precision(A.PRINTPRECISION); out << A.r1c1 << ", ";
	out.setf(std::ios::fixed | std::ios::right); out.width(A.PRINTPRECISION+3); out.precision(A.PRINTPRECISION); out << A.r1c2 << ", ";
	out.setf(std::ios::fixed | std::ios::right); out.width(A.PRINTPRECISION+3); out.precision(A.PRINTPRECISION); out << A.r1c3 << "\n";
	out.setf(std::ios::fixed | std::ios::right); out.width(A.PRINTPRECISION+3); out.precision(A.PRINTPRECISION); out << A.r2c1 << ", ";
	out.setf(std::ios::fixed | std::ios::right); out.width(A.PRINTPRECISION+3); out.precision(A.PRINTPRECISION); out << A.r2c2 << ", ";
	out.setf(std::ios::fixed | std::ios::right); out.width(A.PRINTPRECISION+3); out.precision(A.PRINTPRECISION); out << A.r2c3 << "\n";
	out.setf(std::ios::fixed | std::ios::right); out.width(A.PRINTPRECISION+3); out.precision(A.PRINTPRECISION); out << A.r3c1 << ", ";
	out.setf(std::ios::fixed | std::ios::right); out.width(A.PRINTPRECISION+3); out.precision(A.PRINTPRECISION); out << A.r3c2 << ", ";
	out.setf(std::ios::fixed | std::ios::right); out.width(A.PRINTPRECISION+3); out.precision(A.PRINTPRECISION); out << A.r3c3;
