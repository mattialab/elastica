...
TorsionalWavesCouple::TorsionalWavesCouple(const int argc, const char ** argv)
{
}

TorsionalWavesCouple::~TorsionalWavesCouple()
{
}

bool TorsionalWavesCouple::_test(	const int nEdges, const REAL _dt, const REAL _L, const REAL _r, const REAL _f, const REAL _M, const REAL _timeSimulation, const REAL _G, const REAL _rho,
									const REAL _nu, const REAL _relaxationNu, const string outfileName)
{
	...
	TorsionallWavesCoupleBC endBC = TorsionallWavesCoupleBC(rodPtrs);
...
void TorsionalWavesCouple::_longWaveTest(const int nEdges, const string outputdata)
{
	const REAL rho = 10;
	const REAL G = 1e6;
	const REAL f = 1.0;
