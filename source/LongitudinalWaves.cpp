/*
 * LongitudinalWaves.cpp
 *
 *  Created on: Mar 30, 2015
 *      Author: mgazzola
 */

#include "LongitudinalWaves.h"

LongitudinalWaves::LongitudinalWaves(const int argc, const char ** argv)
{
}

LongitudinalWaves::~LongitudinalWaves()
{
}

bool LongitudinalWaves::_test(	const int nEdges, const REAL _dt, const REAL _L, const REAL _f, const REAL _amplitude, const REAL _timeSimulation, const REAL _E, const REAL _rho,
								const REAL _nu, const REAL _relaxationNu, const string outfileName)
{
	...
	const REAL amplitude = _amplitude;
	...
	const REAL r0 = 0.5*dL0;								// radius [m]
	...
	LongitudinalWavesBC endBC = LongitudinalWavesBC(rodPtrs, amplitude, omega);
...
void LongitudinalWaves::_longWaveTest(const int nEdges, const string outputdata)
{
	...
	const REAL E = 1e6;
	const REAL f = 1.0;
	const REAL nu = 5000.0;
	const REAL T = 1.0/f;
	const REAL L = 3.0*sqrt(E/rho)/(4.0*f);
	const REAL A = 0.05*L;
	const REAL dL = L / nEdges;
	const REAL dt = 0.00005*dL;
	const REAL simTime = 4000*T;
	const REAL halfLife = simTime / 15.0;
	const REAL relaxationNu = halfLife/log(2.0);
	_test(nEdges, dt, L, f, A, simTime, E, rho, nu, relaxationNu, outputdata);
}

void LongitudinalWaves::run()
{
